...
A set of simple tools for splitting, merging, OP deletion, size compression, rewriting attributes and constants, and OP generation for ONNX models.
...
|7|**[soc4onnx](https://github.com/PINTO0309/soc4onnx)**|[WIP]|A very simple tool that forces a change in the opset of an ONNX graph. **S**imple **O**pset **C**hanger for **ONNX**.|
